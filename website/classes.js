...
const dongye = new Country("삼한", ["위치: 마한(경기도, 충청도, 전라도), 진한(경상도 낙동강 동쪽), 변한(낙동강 하류)", "목지국의 지배자가 이 나라를 대표함", "천군과 소도(재정 분라 사회)", "벼농사 발달, 제천 행사(5월 10월)", "철을 생산하여 낙랑과 왜에 수출(화폐로 사용)","마한은 백제, 진한은 신라에 통합, 변한은 가야로 발전"]);
